  ...
  render() {
    ...
    return (
      <div className="shareMain" id="shareMain">
        ...
        <a
          className="resp-sharing-button__link"
          href={`whatsapp://send?text=GiphyReactClone%20${url}`}
          target="_blank"
          rel="noopener noreferrer"
        >
        ...
        <a
          className="resp-sharing-button__link"
          href={`https://telegram.me/share/url?text=GiphyReactClone&url=${url}`}
          target="_blank"
          rel="noopener noreferrer"
        >
        ...
        <a
          className="resp-sharing-button__link"
          href={`https://twitter.com/intent/tweet/?text=GiphyReactClone&url=${url}`}
          target="_blank"
          rel="noopener noreferrer"
        >
        ...
        {showAll ? (
          <Fragment>
            ...
            <a
              className="resp-sharing-button__link"
              href={`https://www.tumblr.com/widgets/share/tool?posttype=link&title=GiphyReactClone&caption=GiphyReactClone&content=${url}&canonicalUrl=${url}&shareSource=tumblr_share_button`}
              target="_blank"
              rel="noopener noreferrer"
            >
            ...
            <a
              className="resp-sharing-button__link"
              href={`mailto:?subject=GiphyReactClone&body=${url}`}
              target="_self"
              rel="noopener noreferrer"
            >
            ...
            <a
              className="resp-sharing-button__link"
              href={`https://pinterest.com/pin/create/button/?url=${url}&media=${url}&description=GiphyReactClone`}
              target="_blank"
              rel="noopener noreferrer"
            >
            ...
            <a
              className="resp-sharing-button__link"
              href={`https://www.linkedin.com/shareArticle?mini=true&url=${url}&title=GiphyReactClone&summary=GiphyReactClone&source=${url}`}
              target="_blank"
              rel="noopener noreferrer"
            >
            ...
            <a
              className="resp-sharing-button__link"
              href={`https://reddit.com/submit/?url=${url}&resubmit=true&title=GiphyReactClone`}
              target="_blank"
              rel="noopener noreferrer"
            >
            ...
            <a
              className="resp-sharing-button__link"
              href={`https://www.xing.com/app/user?op=share;url=${url};title=GiphyReactClone`}
              target="_blank"
              rel="noopener noreferrer"
            >
            ...
            <a
              className="resp-sharing-button__link"
              href={`https://news.ycombinator.com/submitlink?u=${url}&t=GiphyReactClone`}
              target="_blank"
              rel="noopener noreferrer"
            >
            ...
            <a
              className="resp-sharing-button__link"
              href={`http://vk.com/share.php?title=GiphyReactClone&url=${url}`}
              target="_blank"
              rel="noopener noreferrer"
            >
